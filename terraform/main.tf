...
module "key_vault" {
  ...
  secrets = {
    ...
    pgvector-dsn      = var.pgvector_dsn
    qdrant-url        = var.qdrant_url
    qdrant-api-key-ro = var.qdrant_api_key_ro
    qdrant-api-key-rw = var.qdrant_api_key_rw
...
module "container_apps" {
  ...
  qdrant_api_key_ro        = var.qdrant_api_key_ro
  pinecone_api_key         = var.pinecone_api_key
  pgvector_dsn             = var.pgvector_dsn
  ...
  chat_rate_limit          = var.chat_rate_limit
